<div class="flight-wrapper">
					...
					<form action="<?php echo base_url() ?>booking/proccess" method="POST">
						...
						<table class="customer-table">
							...
							<tr>
								...
								<td>
									<input name="seat[]" class="form-control" id="i<?php echo $i ?>" type="text" readonly>
								</td>
							</tr>
			...
			<div class="flight-booking-1">
				...
				<table class="flight-table">
					...
					<tr>
						...
						<td> : </td>
						<td>
							<?php echo $data_rute['rute_from']?> - <?php echo $data_rute['rute_to']?> 
						</td>
					</tr>
					<tr>
						<td>Depart</td>
	...
	<div name="myForm" action="/action_page.php" onsubmit="return validateForm()" method="post">
