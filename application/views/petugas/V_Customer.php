						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger" href="<?php echo base_url() ?>petugas/customer/delete/<?php echo $value['id']?>">Delete</a>
								</td>
							</tr>
							<?php endforeach; ?>
						</tbody>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<!-- ################# -->
									<form role="form" action="<?php echo base_url() ?>petugas/customer/add" method="POST">
