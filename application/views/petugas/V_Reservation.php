						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger" href="<?php echo base_url() ?>petugas/reservation/delete/<?php echo $value['id']?>">Delete</a>
								</td>
							</tr>
							<?php $i++ ?>
							<?php endforeach; ?>
