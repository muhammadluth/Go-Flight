	...
	<header id="fh5co-header-section" class="sticky-banner">
		<div class="container">
			<div class="nav-header">
				...
				<h1 id="fh5co-logo"><a href="<?php echo base_url() ?>"></i>GO-FLIGHT</a></h1>
				<!-- START #fh5co-menu-wrap -->
				<nav id="fh5co-menu-wrap" role="navigation">
					<ul class="sf-menu" id="fh5co-primary-menu">
						<li class="active"><a href="<?php echo base_url() ?>">Page User</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright 2019 GO-FLIGHT. All Rights Reserved. <br>Made with <i class="icon-heart3"></i> by <a href="http://jondes.com/" target="_blank">JONDES</a></p>
						</div>
					</div>
				</div>
			</div>
