...
class transportation extends CI_Controller {
	...
	{	
		...
		$transportation_type = $this->M_Transportation_Admin->get_transportion_type();
		$data['transportation'] = $transportation;
		$data['transportation_type'] = $transportation_type;
    ...
    public function add(){
        ...
        $transportation_type = $this->input->post('type');
    ...
    // public function add_tranportation_type{
